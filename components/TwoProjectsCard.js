...
const TwoProjectsCard = ({ img, title, description, github, link }) => {
  return (
    <div className="min-w-fit border-r-2 h-fit border-l-2 text-twoTextDark border-twoTextDark cursor-pointer transform hover:scale-105 duration-300 hover:shadow-2xl">
